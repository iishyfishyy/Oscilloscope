var WebGLLines = function(attrs) {
  ...
  ";
    ...
    this.rainbow_cursors     = true;  // easter egg ;))
    ...
    this.startDrag = function(x, y) {
        ...
        var wireFramePositions_raw = this.triangulate.build(wireFramePositions);
        this.wireFramePositions = {cells:[],positions:[]};
        for(var i = 0; i < wireFramePositions_raw.positions.length; i++){
            this.wireFramePositions.positions.push(wireFramePositions_raw.positions[i][0],wireFramePositions_raw.positions[i][1]);
        }
        for(var i = 0; i < wireFramePositions_raw.cells.length; i++){
            this.wireFramePositions.cells.push(wireFramePositions_raw.cells[i][0],wireFramePositions_raw.cells[i][1],wireFramePositions_raw.cells[i][2]);
        }
    ...
    this.updateDrag = function(x, y) {
        if (this.mouseDragging) {
            ...
            var lastlen = this.triangulate.thickness;
            this.triangulate.thickness = lastlen*2;
            var wireFramePositions_raw = this.triangulate.build(wireFramePositions);
            this.triangulate.thickness = lastlen;
            this.wireFramePositions = {cells:[],positions:[]};
            for(var i = 0; i < wireFramePositions_raw.positions.length; i++){
                this.wireFramePositions.positions.push(wireFramePositions_raw.positions[i][0],wireFramePositions_raw.positions[i][1]);
            }
    ...
    this.lineVertices = [];
    this.indicesCount = [];
    this.minimapLineVertices = [];
    this.minimapIndicesCount = [];
    this.gridLineWidth = attrs.stroke.thickness;
    ...
    this.majorGridPositions.push(-1    , -this.gridLineWidth);
    this.majorGridPositions.push(-1    , +this.gridLineWidth);
    this.majorGridPositions.push(+1    , -this.gridLineWidth);
    this.majorGridPositions.push(+1    , -this.gridLineWidth);
    this.majorGridPositions.push(+1    , +this.gridLineWidth);
    ...
    this.majorGridPositions.push(-this.gridLineWidth, -1);
    this.majorGridPositions.push(+this.gridLineWidth, -1);
    this.majorGridPositions.push(+this.gridLineWidth, +1);
    this.majorGridPositions.push(+this.gridLineWidth, +1);
    this.majorGridPositions.push(-this.gridLineWidth, +1);
    ...
    this.horizontalCursorPositions.push(-1, this.horizontalCursorY[0] - this.gridLineWidth);
    this.horizontalCursorPositions.push(-1, this.horizontalCursorY[0] + this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[0] - this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[0] - this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[0] + this.gridLineWidth);
    ...
    this.horizontalCursorPositions.push(-1, this.horizontalCursorY[1] - this.gridLineWidth);
    this.horizontalCursorPositions.push(-1, this.horizontalCursorY[1] + this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[1] - this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[1] - this.gridLineWidth);
    this.horizontalCursorPositions.push(+1, this.horizontalCursorY[1] + this.gridLineWidth);
    ...
    this.verticalCursorPositions.push(this.verticalCursorX[0] - this.gridLineWidth, -1);
    this.verticalCursorPositions.push(this.verticalCursorX[0] + this.gridLineWidth, -1);
    this.verticalCursorPositions.push(this.verticalCursorX[0] + this.gridLineWidth, +1);
    this.verticalCursorPositions.push(this.verticalCursorX[0] + this.gridLineWidth, +1);
    this.verticalCursorPositions.push(this.verticalCursorX[0] - this.gridLineWidth, +1);
    ...
    this.verticalCursorPositions.push(this.verticalCursorX[1] - this.gridLineWidth, -1);
    this.verticalCursorPositions.push(this.verticalCursorX[1] + this.gridLineWidth, -1);
    this.verticalCursorPositions.push(this.verticalCursorX[1] + this.gridLineWidth, +1);
    this.verticalCursorPositions.push(this.verticalCursorX[1] + this.gridLineWidth, +1);
    this.verticalCursorPositions.push(this.verticalCursorX[1] - this.gridLineWidth, +1);
    ...
    this.gridPositions = [];
    this.dashlen       = 0.01;
    for (var i = -this.numDivs; i <= this.numDivs; i+=1) {
        var len = this.gridLineWidth;
        for (var j = -1; j <= 1; j += this.dashlen * 2) {
            this.gridPositions.push(j + this.dashlen               , (i / this.numDivs) - len);
            this.gridPositions.push(j + this.dashlen               , (i / this.numDivs) + len);
            this.gridPositions.push(j + this.dashlen + this.dashlen, (i / this.numDivs) - len);
            this.gridPositions.push(j + this.dashlen + this.dashlen, (i / this.numDivs) - len);
            this.gridPositions.push(j + this.dashlen + this.dashlen, (i / this.numDivs) + len);
            this.gridPositions.push(j + this.dashlen               , (i / this.numDivs) + len);
        }
        for (var j = -1; j <= 1; j += this.dashlen * 2) {
            this.gridPositions.push((i / this.numDivs) - len, j + this.dashlen);
            this.gridPositions.push((i / this.numDivs) + len, j + this.dashlen);
            this.gridPositions.push((i / this.numDivs) - len, j + this.dashlen + this.dashlen);
            this.gridPositions.push((i / this.numDivs) - len, j + this.dashlen + this.dashlen);
            this.gridPositions.push((i / this.numDivs) + len, j + this.dashlen + this.dashlen);
            this.gridPositions.push((i / this.numDivs) + len, j + this.dashlen);
        }
    ...
    for (var i = -this.numDivs; i < this.numDivs; i++) {
        this.tickPositions.push(-1    , (i / this.numDivs) - this.gridLineWidth);
        this.tickPositions.push(-1    , (i / this.numDivs) + this.gridLineWidth);
        this.tickPositions.push(-0.975, (i / this.numDivs) - this.gridLineWidth);
        this.tickPositions.push(-0.975, (i / this.numDivs) - this.gridLineWidth);
        this.tickPositions.push(-0.975, (i / this.numDivs) + this.gridLineWidth);
        this.tickPositions.push(-1    , (i / this.numDivs) + this.gridLineWidth);
        
        this.tickPositions.push((i / this.numDivs) - this.gridLineWidth, -1);
        this.tickPositions.push((i / this.numDivs) + this.gridLineWidth, -1);
        this.tickPositions.push((i / this.numDivs) + this.gridLineWidth, -0.965);
        this.tickPositions.push((i / this.numDivs) + this.gridLineWidth, -0.965);
        this.tickPositions.push((i / this.numDivs) - this.gridLineWidth, -0.965);
        this.tickPositions.push((i / this.numDivs) - this.gridLineWidth, -1);
    ...
    for(var i = -1; i <= 1; i+=2){
        ...
        this.boundaryPositions.push( i, i + len);
        this.boundaryPositions.push( i, i - len);
        this.boundaryPositions.push(-i, i + len);
        this.boundaryPositions.push(-i, i + len);
        this.boundaryPositions.push(-i, i - len);
        ...
        this.boundaryPositions.push(-i + len, -i);
        this.boundaryPositions.push(-i - len, -i);
        this.boundaryPositions.push(-i + len,  i);
        this.boundaryPositions.push(-i + len,  i);
        this.boundaryPositions.push(-i - len,  i);
    ...
    this.minimapBoundaryPositions = [];
    this.minimapBoundaryPositions.push(-1, -0.99875);
    this.minimapBoundaryPositions.push(+1, -0.99875);
    this.minimapBoundaryPositions.push(-1, +0.99875);
    this.minimapBoundaryPositions.push(+1, +0.99875);
    this.minimapBoundaryPositions.push(-1, -1);
    this.minimapBoundaryPositions.push(-1, +1);
    this.minimapBoundaryPositions.push(+1, -1);
    this.minimapBoundaryPositions.push(+1, +1);
    ...
    this.update = function(newPts, waveformNumber, visible) {
        this.triangulate.thickness = Math.abs(this.currentRight - this.currentLeft) > Math.abs(this.currentTop - this.currentBottom) ? Math.abs(this.currentRight - this.currentLeft) : Math.abs(this.currentTop - this.currentBottom);
        var points = [];
        for(var i = 0; i < newPts.length; i+=2){
            points.push([newPts[i], newPts[i+1]]);
        }
        var line_mesh_raw = this.triangulate.build(points);
        var line_mesh_final = {cells:[],positions:[]};
        for(var i = 0; i < line_mesh_raw.positions.length; i++){
            line_mesh_final.positions.push(line_mesh_raw.positions[i][0],line_mesh_raw.positions[i][1]);
        }
        for(var i = 0; i < line_mesh_raw.cells.length; i++){
            line_mesh_final.cells.push(line_mesh_raw.cells[i][0],line_mesh_raw.cells[i][1],line_mesh_raw.cells[i][2]);
        }
        var faces  = [];
        for (var i = 0; i < this.minimapLineVertices.length; i++) faces.push(i);
        this.linesToDraw[waveformNumber] = {
            vertices: line_mesh_final.positions,
            indicesCount: line_mesh_final.cells,
            minimapVertices: newPts,
            minimapIndicesCount: faces,
            visible: visible //if visible is false, we will not draw this channel in drawLines()
        }
        this.triangulate.thickness = this.gridLineWidth;
    };
    ...
    this.drawBoundaries = function() {
        ...
        this.gl.drawArrays(this.gl.TRIANGLES, 0, this.boundaryPositions.length / 2);
    };
    ...
    this.minimapDrawGrids = function() {
        this.minimapBoundaryPositions[8]  = -0.9988;
        this.minimapBoundaryPositions[10] = -0.9988;
        ...
        this.minimapGL.bufferData(this.minimapGL.ARRAY_BUFFER, new Float32Array(this.minimapBoundaryPositions), this.minimapGL.STATIC_DRAW);
        ...
        this.minimapGL.drawArrays(this.minimapGL.LINES, 0, this.minimapBoundaryPositions.length / 2);
        this.minimapBoundaryPositions[8]  = -1;
        this.minimapBoundaryPositions[10] = -1;
    };
        ...
        for (var i = 0; i < this.linesToDraw.length; i++) {
            if (this.linesToDraw[i].visible) { //draw only if channel visible
                ...
                if (this.linesToDraw[i].indicesCount.length > 0) {
                    this.gl.vertexAttribPointer(this.wave_position_location, 2, this.gl.FLOAT, false, 0, 0);
                    ...
                    this.gl.drawElements(this.gl.TRIANGLES, this.indicesCount.length, this.gl.UNSIGNED_SHORT, 0);
                }
            }
        }
    };
    ...
    this.drawGridsOnBuffer = function(){
        ...
        this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
        this.gl.uniform4fv(this.grid_color_position, color);
        this.gl.drawArrays(this.gl.TRIANGLES, 0, this.gridPositions.length / 2);
        ...
        this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
        this.gl.uniform4fv(this.grid_color_position, color);
        this.gl.drawArrays(this.gl.TRIANGLES, 0, this.majorGridPositions.length / 2);        
        
        this.bindVertexBuffer(this.tickPositions);
        this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
        this.gl.uniform4fv(this.grid_color_position, color);
        this.gl.drawArrays(this.gl.TRIANGLES, 0, this.tickPositions.length / 2);
    ...
    this.updateHorizontalCursorPositions = function(){
        this.horizontalCursorPositions = [];
    ...
    this.updateVerticalCursorPositions = function(){
        this.verticalCursorPositions = [];
    ...
    this.rainbowFactor= [Math.random()/100, Math.random()/100, Math.random()/100];
    this.drawCursors = function(horizontal, vertical){
        ...
        if(horizontal){
            ...
            this.updateHorizontalCursorPositions();

            var distance_line_positions = [];

            distance_line_positions.push(-0.95 - this.gridLineWidth, this.horizontalCursorY[0]);
            distance_line_positions.push(-0.95 + this.gridLineWidth, this.horizontalCursorY[0]);
            distance_line_positions.push(-0.95 - this.gridLineWidth, this.horizontalCursorY[1]);
            distance_line_positions.push(-0.95 - this.gridLineWidth, this.horizontalCursorY[1]);
            distance_line_positions.push(-0.95 + this.gridLineWidth, this.horizontalCursorY[1]);
            distance_line_positions.push(-0.95 + this.gridLineWidth, this.horizontalCursorY[0]);
            ...
            this.gl.drawArrays(this.gl.TRIANGLES, 0, distance_line_positions.length / 2);
            ...
            this.h_cursor_x       = (-0.93 - this.unzoomedLeft) / ((this.unzoomedRight - this.unzoomedLeft) / this.canvasParent.offsetWidth);

            var distance_line_triangle_left = [
                -0.95        , this.horizontalCursorY[0],
                -0.95 + 0.015, this.horizontalCursorY[0] - 0.02,
                -0.95 - 0.015, this.horizontalCursorY[0] - 0.02,
            ];

            var distance_line_triangle_right = [
                -0.95        , this.horizontalCursorY[1],
                -0.95 + 0.015, this.horizontalCursorY[1] + 0.02,
                -0.95 - 0.015, this.horizontalCursorY[1] + 0.02,
            ];
            ...
            this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
            this.gl.uniform4fv(this.grid_color_position, color);
            this.gl.drawArrays(this.gl.TRIANGLES, 0, this.horizontalCursorPositions.length / 2);
        }
        if(vertical){

            this.updateVerticalCursorPositions();

            var distance_line_positions = [];

            distance_line_positions.push(this.verticalCursorX[0], -0.95 - this.gridLineWidth);
            distance_line_positions.push(this.verticalCursorX[0], -0.95 + this.gridLineWidth);
            distance_line_positions.push(this.verticalCursorX[1], -0.95 + this.gridLineWidth);
            distance_line_positions.push(this.verticalCursorX[1], -0.95 + this.gridLineWidth);
            distance_line_positions.push(this.verticalCursorX[1], -0.95 - this.gridLineWidth);
            distance_line_positions.push(this.verticalCursorX[0], -0.95 - this.gridLineWidth);
            ...
            this.v_cursor_y       = (-0.9 - this.unzoomedTop) / ((this.unzoomedBottom - this.unzoomedTop) / this.canvasParent.offsetHeight);

            var distance_line_triangle_left = [
                this.verticalCursorX[1]        , -0.95,
                this.verticalCursorX[1] + 0.015, -0.95 + 0.02,
                this.verticalCursorX[1] + 0.015, -0.95 - 0.02,
            ];

            var distance_line_triangle_right = [
                this.verticalCursorX[0]        , -0.95,
                this.verticalCursorX[0] - 0.015, -0.95 + 0.02,
                this.verticalCursorX[0] - 0.015, -0.95 - 0.02,
            ];
            ...
            this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
            this.gl.uniform4fv(this.grid_color_position, color);
            this.gl.drawArrays(this.gl.TRIANGLES, 0, this.verticalCursorPositions.length / 2);
        }
    ...
    this.displayCursorValues = function(horizontal, vertical){
        if(horizontal){
            ...
            var a = this.scaleBetween(unscaledY1, this.scaleBetween(this.currentBottom, this.ymin, this.ymax, -1, 1), this.scaleBetween(this.currentTop, this.ymin, this.ymax, -1, 1), -1, +1);
            var b = this.scaleBetween(unscaledY2, this.scaleBetween(this.currentBottom, this.ymin, this.ymax, -1, 1), this.scaleBetween(this.currentTop, this.ymin, this.ymax, -1, 1), -1, +1) * -1;
    ...
    this.drawSelectionBox = function(){
        ...
        this.bindVertexBuffer(this.wireFramePositions.positions);
        this.bindIndicesBuffer(this.wireFramePositions.cells);
        this.gl.vertexAttribPointer(this.grid_position_location, 2, this.gl.FLOAT, false, 0, 0);
        this.gl.uniform4fv(this.grid_color_position, color);
        this.gl.drawElements(this.gl.TRIANGLES, this.wireFramePositions.cells.length, this.gl.UNSIGNED_SHORT, 0);
    ...
    this.minimapDrawLines = function(scale) {
        ...
        for (var i = 0; i < this.linesToDraw.length; i++) {
            if (this.linesToDraw[i].visible) {
                var color = [this.colors[i].r / 255, this.colors[i].g / 255, this.colors[i].b / 255, 1.];
                this.minimapLineVertices = this.linesToDraw[i].minimapVertices;
                this.minimapGL.bindBuffer(this.minimapGL.ARRAY_BUFFER, this.minimapVertexBuffer);
                this.minimapGL.bufferData(this.minimapGL.ARRAY_BUFFER, new Float32Array(this.minimapLineVertices), this.gl.STATIC_DRAW);
                this.minimapIndicesCount = this.linesToDraw[i].minimapIndicesCount;
                this.minimapGL.bindBuffer(this.minimapGL.ELEMENT_ARRAY_BUFFER, this.minimapIndicesBuffer);
                this.minimapGL.bufferData(this.minimapGL.ELEMENT_ARRAY_BUFFER, new Uint16Array(this.minimapIndicesCount), this.gl.STATIC_DRAW);
                if (this.linesToDraw[i].indicesCount.length > 0) {
                    ...
                    this.minimapGL.drawElements(this.minimapGL.LINE_STRIP, this.minimapIndicesCount.length / 4, this.minimapGL.UNSIGNED_SHORT, 0);
                }
            }
        }
    };
    ...
    this.resize = function() {
        ...
        if (this.canvas.width !== canvasWidth || this.canvas.height !== canvasHeight) {
            ...
            this.canvas.width        = canvasWidth  * this.canvasscale * devicePixelRatio;
            this.canvas.height       = canvasHeight * this.canvasscale * devicePixelRatio;
    ...
    this.draw = function(scale) {
        ...
        this.gl.blendFunc(this.gl.SRC_ALPHA, this.gl.ONE_MINUS_SRC_ALPHA); //end additive blending!!!
        this.drawBoundaries();
        if (this.clearFlag) {
            this.blackout();
